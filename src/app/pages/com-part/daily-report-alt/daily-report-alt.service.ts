...
@Injectable()
export class DailyReportAltService {
...
saveGen(body: any):Observable<any>{
    return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveGen}`, body)
}
saveHse(body: any):Observable<any>{
  return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveHse}`, body)
}
saveConstructionActivities(body: any):Observable<any>{
  return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveConstructionActivities}`, body)
}
saveDailyProgressMeasurement(body: any):Observable<any>{
  return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveDailyProgressMeasurement}`, body)
}
saveProgressPictures(body: any):Observable<any>{
  return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveProgressPictures}`, body)
}
saveOtherSite(body: any):Observable<any>{
  return this.http.post(`${environment.apiUrl}${constant.DailyReport.saveOtherSite}`, body)
}
